...
-- Supabase Veritabanı Kurulum Scripti (Tam Versiyon)
...
DROP VIEW IF EXISTS v_personel_summary CASCADE;
...
-- Row Level Security (RLS) Policies - Basit
...
CREATE POLICY "Enable all access for personel" ON personel FOR ALL USING (true);
CREATE POLICY "Enable all access for month_status" ON month_status FOR ALL USING (true);
CREATE POLICY "Enable read access for audit_log" ON audit_log FOR SELECT USING (true);
...
INSERT INTO personel (firma_id, month, isim, telefon, email, departman, pozisyon, brut_maas, calistigi_gun, adres) VALUES
-- HC Sigorta Ana
('firma-1', '2024-09', 'Dr. Ahmet Yılmaz', '0532 123 4567', 'ahmet@hcsigorta.com', 'Yönetim', 'Genel Müdür', 80000, 22, 'İstanbul'),
('firma-1', '2024-09', 'Ayşe Kaya', '0533 234 5678', 'ayse@hcsigorta.com', 'İnsan Kaynakları', 'İK Uzmanı', 35000, 22, 'İstanbul'),
('firma-1', '2024-09', 'Mehmet Demir', '0534 345 6789', 'mehmet@hcsigorta.com', 'Satış', 'Satış Temsilcisi', 28000, 20, 'Ankara'),

-- HC Teknoloji
('firma-2', '2024-09', 'Fatma Şahin', '0535 456 7890', 'fatma@hcteknoloji.com', 'IT', 'Yazılım Geliştirici', 45000, 22, 'İstanbul'),
('firma-2', '2024-09', 'Ali Yıldız', '0536 567 8901', 'ali@hcteknoloji.com', 'IT', 'Sistem Yöneticisi', 40000, 22, 'İzmir'),

-- HC Danışmanlık
('firma-3', '2024-09', 'Zeynep Özkan', '0537 678 9012', 'zeynep@hcdanismanlik.com', 'Hukuk', 'Hukuk Müşaviri', 50000, 22, 'Ankara');
